...
def training_log_entry(Luna):
    ...
    training_entry= models.Training_Log(datetime.now(), Luna,"Canicross",models.Runner("JC",models.Kennel("Team Running Huskies"),\
...
@pytest.fixture
def Luna():
    return models.Dog('Luna',datetime(2017,4,18),models.Kennel("Team Running Huskies"))
...
def test_weather_raises_ValError_if_not_in_list():
    with pytest.raises(ValueError):
        weather=models.Weather(20,77,sky_condition='clear')
